...
function showBasketTemplate(indexBasket) {
    ...
    <div class="showBasketMenu"> 
        ...
        <div class="for_btn_and_price">
            ...
            <div>
                <button class="btn_increase_recycle" onclick="changeAmount('reduce', ${indexBasket})"><img src="./assets/icons/minus.svg" alt="Menge mindern"></button>
                ...
                <button class="btn_increase_recycle" onclick="changeAmount('increase', ${indexBasket})"><img src="./assets/icons/plus-circle.svg" alt="erhöhe die Menge"></button>
            </div>
        </div>
    </div>    
    `
